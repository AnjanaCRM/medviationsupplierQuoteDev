...
function App() {
  ...
  const API_URL = "https://developer-crmapay.cs214.force.com/InteractPay/services/apexrest/MedviationAuthorization?methodType=GET&inputParams=" + JSON.stringify(params);
  console.log(API_URL);
